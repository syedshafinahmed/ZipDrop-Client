    ...
    <div className="drawer lg:drawer-open bg-gray-200">
      ...
      <div className="drawer-content">
        ...
        <nav className="navbar w-full bg-base-300">
          ...
          <div className="px-4 font-black">ZipDrop Dashboard</div>
        </nav>
        {/* Page content here */}
        <Outlet></Outlet>
      </div>
          ...
          <ul className="menu w-full grow">
            ...
            <li>
              <Link to='/' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Homepage">
                {/* Home icon */}
                <FaHome size={20} color="#03373D"></FaHome>
            ...
            {/* dashboard links */}
            <li>
              <NavLink to='/send-parcel' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Send Parcel"><IoSend size={20} color="#03373D" />
                <span className="is-drawer-close:hidden font-bold">Send Parcel</span></NavLink>
            </li>
            <li>
              <NavLink to='/dashboard/my-parcels' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Parcels"><FaShippingFast size={20} color="#03373D" />
            ...
            {/* admin only links */}
            {
              ...
              <>
                <li>
                  <NavLink to='/dashboard/approve-riders' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Approve Riders"><FaMotorcycle size={20} color="#03373D" />
                    <span className="is-drawer-close:hidden font-bold">Approve Riders</span></NavLink>
                </li>
                <li>
                  <NavLink to='/dashboard/assign-riders' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Assign Riders"><MdAssignmentInd size={20} color="#03373D" />
                    <span className="is-drawer-close:hidden font-bold">Assign Riders</span></NavLink>
                </li>
                <li>
                  <NavLink to='/dashboard/users-management' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Users Management"><FaUsers size={20} color="#03373D" />
            ...
            <li>
              <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Settings">
                <IoSettingsSharp size={20} color="#03373D" />
